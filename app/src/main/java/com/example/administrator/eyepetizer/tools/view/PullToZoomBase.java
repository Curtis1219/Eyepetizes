...
public abstract class PullToZoomBase<T extends View> extends LinearLayout implements IPullToZoom<T> {
    ...
    private void pullEvent() {
        ...
        final int newScrollValueX;
        final float initialMotionValueX, lastMotionValueX;

        initialMotionValueX = mInitialMotionX;
        lastMotionValueX = mLastMotionX;
        ...
        newScrollValueX = Math.round(Math.min(initialMotionValue - lastMotionValue, mHeaderView.getWidth()) / FRICTION);
//        newScrollValueX = Math.round(Math.min(initialMotionValueX + lastMotionValueX, initialMotionValueX) / FRICTION);

        pullHeaderToZoom(newScrollValue, newScrollValueX);
        if (onPullZoomListener != null) {
    ...
    protected abstract void pullHeaderToZoom(int newScrollValue,int newScrollValueX);
